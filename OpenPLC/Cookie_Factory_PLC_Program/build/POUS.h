...
typedef struct {
  ...
  __DECLARE_LOCATED(BOOL,WRAPPER_CONVEYING)
  ...
  __DECLARE_LOCATED(INT,PALLETIZER_ROTATION)
  __DECLARE_LOCATED(INT,BOX_COUNT)
  __DECLARE_LOCATED(BOOL,WRAPPER_WRAPPING)
  __DECLARE_LOCATED(BOOL,BOXING)
  __DECLARE_LOCATED(BOOL,TAPING)
  __DECLARE_LOCATED(BOOL,CONVEYING_1)
  __DECLARE_LOCATED(BOOL,CONVEYING_2)
  __DECLARE_LOCATED(BOOL,CONVEYING_3)
  __DECLARE_LOCATED(BOOL,CONVEYING_4)
  __DECLARE_LOCATED(BOOL,CONVEYING_5)
  __DECLARE_LOCATED(BOOL,PALLETIZER_MOVING)
  __DECLARE_LOCATED(BOOL,BAGGING)
  __DECLARE_LOCATED(INT,MACHINE_1)
  __DECLARE_LOCATED(INT,MACHINE_2)
  __DECLARE_LOCATED(INT,MACHINE_3)
  __DECLARE_LOCATED(INT,MACHINE_4)
  ...
  __DECLARE_LOCATED(BOOL,ROE_1)
  __DECLARE_LOCATED(BOOL,ROE_2)
  __DECLARE_LOCATED(BOOL,ROE_3)
  __DECLARE_LOCATED(BOOL,ADD_INGREDIENTS)
  __DECLARE_LOCATED(BOOL,WORKER_PRESENT)
