...
void CONVEYOR_FPM_FUNCTION_body__(CONVEYOR_FPM_FUNCTION *data__) {
  ...
  if (__GET_VAR(data__->CONVEYOR,)) {
    ...
    __SET_VAR(data__->,CONVEYOR_FPM,,0.0);
  };
...
void WIRECUT_CPM_FUNCTION_init__(WIRECUT_CPM_FUNCTION *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->CONVEYOR,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->TROUGH_WEIGHT,0,retain)
}
...
void WIRECUT_CPM_FUNCTION_body__(WIRECUT_CPM_FUNCTION *data__) {
  ...
  if (((__GET_VAR(data__->WIRECUTTER,) && __GET_VAR(data__->CONVEYOR,)) && (__GET_VAR(data__->TROUGH_WEIGHT,) > 0.0))) {
...
void TAG_DISPLAY_init__(TAG_DISPLAY *data__, BOOL retain) {
  ...
  __INIT_LOCATED(BOOL,__QX91_1,data__->WRAPPER_CONVEYING,retain)
  __INIT_LOCATED_VALUE(data__->WRAPPER_CONVEYING,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX91_2,data__->CONVEYOR_1,retain)
  __INIT_LOCATED_VALUE(data__->CONVEYOR_1,__BOOL_LITERAL(TRUE))
  __INIT_LOCATED(BOOL,__QX91_3,data__->CONVEYOR_2,retain)
  __INIT_LOCATED_VALUE(data__->CONVEYOR_2,__BOOL_LITERAL(TRUE))
  __INIT_LOCATED(BOOL,__QX91_4,data__->CONVEYOR_3,retain)
  __INIT_LOCATED_VALUE(data__->CONVEYOR_3,__BOOL_LITERAL(TRUE))
  __INIT_LOCATED(BOOL,__QX91_5,data__->CONVEYOR_4,retain)
  __INIT_LOCATED_VALUE(data__->CONVEYOR_4,__BOOL_LITERAL(TRUE))
  __INIT_LOCATED(BOOL,__QX91_6,data__->CONVEYOR_5,retain)
  __INIT_LOCATED_VALUE(data__->CONVEYOR_5,__BOOL_LITERAL(TRUE))
  ...
  __INIT_LOCATED(INT,__QW1012,data__->PALLETIZER_ROTATION,retain)
  __INIT_LOCATED_VALUE(data__->PALLETIZER_ROTATION,180)
  __INIT_LOCATED(INT,__QW1013,data__->BOX_COUNT,retain)
  ...
  __INIT_LOCATED(BOOL,__QX92_7,data__->BOXING,retain)
  __INIT_LOCATED_VALUE(data__->BOXING,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX93_0,data__->TAPING,retain)
  __INIT_LOCATED_VALUE(data__->TAPING,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX93_1,data__->CONVEYING_1,retain)
  __INIT_LOCATED_VALUE(data__->CONVEYING_1,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX93_2,data__->CONVEYING_2,retain)
  __INIT_LOCATED_VALUE(data__->CONVEYING_2,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX93_3,data__->CONVEYING_3,retain)
  __INIT_LOCATED_VALUE(data__->CONVEYING_3,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX93_4,data__->CONVEYING_4,retain)
  __INIT_LOCATED_VALUE(data__->CONVEYING_4,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX93_5,data__->CONVEYING_5,retain)
  __INIT_LOCATED_VALUE(data__->CONVEYING_5,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX93_6,data__->PALLETIZER_MOVING,retain)
  __INIT_LOCATED_VALUE(data__->PALLETIZER_MOVING,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX93_7,data__->BAGGING,retain)
  __INIT_LOCATED_VALUE(data__->BAGGING,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(INT,__QW500,data__->MACHINE_1,retain)
  __INIT_LOCATED_VALUE(data__->MACHINE_1,0)
  __INIT_LOCATED(INT,__QW501,data__->MACHINE_2,retain)
  __INIT_LOCATED_VALUE(data__->MACHINE_2,0)
  __INIT_LOCATED(INT,__QW502,data__->MACHINE_3,retain)
  __INIT_LOCATED_VALUE(data__->MACHINE_3,0)
  __INIT_LOCATED(INT,__QW503,data__->MACHINE_4,retain)
  __INIT_LOCATED_VALUE(data__->MACHINE_4,0)
  ...
  __INIT_LOCATED(BOOL,__QX94_0,data__->ROE_1,retain)
  __INIT_LOCATED_VALUE(data__->ROE_1,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX94_1,data__->ROE_2,retain)
  __INIT_LOCATED_VALUE(data__->ROE_2,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__QX94_2,data__->ROE_3,retain)
  ...
  __INIT_LOCATED_VALUE(data__->WORKER_PRESENT,__BOOL_LITERAL(TRUE))
...
void TAG_DISPLAY_body__(TAG_DISPLAY *data__) {
  ...
  __SET_VAR(data__->CONVEYOR_FPM_FUNCTION0.,CONVEYOR,,__GET_LOCATED(data__->CONVEYOR,));
  ...
  __SET_VAR(data__->WIRECUT_CPM_FUNCTION0.,CONVEYOR,,__GET_LOCATED(data__->CONVEYOR,));
  __SET_VAR(data__->WIRECUT_CPM_FUNCTION0.,TROUGH_WEIGHT,,__GET_LOCATED(data__->TROUGH_WEIGHT,));
  ...
  __SET_VAR(data__->,_TMP_EQ167_OUT,,EQ__BOOL__INT(
    ...
    NULL,
    (UINT)2,
    (INT)__GET_LOCATED(data__->MACHINE_1,),
    (INT)__GET_VAR(data__->STATE_0,)));
  if ((__GET_LOCATED(data__->BOX_MAKER,) && __GET_VAR(data__->_TMP_EQ167_OUT,))) {
    __SET_LOCATED(data__->,BOXING,,__BOOL_LITERAL(TRUE));
  };
  __SET_VAR(data__->,_TMP_MOVE174_OUT,,__TAG_DISPLAY_MOVE__INT__INT1(
    (BOOL)(__GET_LOCATED(data__->BOX_MAKER,) && __GET_VAR(data__->_TMP_EQ167_OUT,)),
    (INT)__GET_VAR(data__->STATE_1,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE174_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_1,,__GET_VAR(data__->_TMP_MOVE174_OUT,));
  };
  __SET_VAR(data__->,_TMP_EQ113_OUT,,EQ__BOOL__INT(
    ...
    (INT)__GET_LOCATED(data__->MACHINE_1,),
    (INT)__GET_VAR(data__->STATE_1,)));
  if (((__GET_LOCATED(data__->CONVEYOR_1,) && !(__GET_LOCATED(data__->BOXING,))) && __GET_VAR(data__->_TMP_EQ113_OUT,))) {
    __SET_LOCATED(data__->,CONVEYING_1,,__BOOL_LITERAL(TRUE));
  };
  __SET_VAR(data__->,_TMP_MOVE120_OUT,,__TAG_DISPLAY_MOVE__INT__INT2(
    (BOOL)((__GET_LOCATED(data__->CONVEYOR_1,) && !(__GET_LOCATED(data__->BOXING,))) && __GET_VAR(data__->_TMP_EQ113_OUT,)),
    (INT)__GET_VAR(data__->STATE_2,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE120_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_1,,__GET_VAR(data__->_TMP_MOVE120_OUT,));
  };
  __SET_VAR(data__->,_TMP_EQ125_OUT,,EQ__BOOL__INT(
    ...
    (INT)__GET_LOCATED(data__->MACHINE_1,),
    (INT)__GET_VAR(data__->STATE_2,)));
  if (((__GET_LOCATED(data__->BAGGER,) && __GET_LOCATED(data__->PS_1,)) && __GET_VAR(data__->_TMP_EQ125_OUT,))) {
    __SET_LOCATED(data__->,BAGGING,,__BOOL_LITERAL(TRUE));
  };
  __SET_VAR(data__->,_TMP_MOVE133_OUT,,__TAG_DISPLAY_MOVE__INT__INT3(
    (BOOL)((__GET_LOCATED(data__->BAGGER,) && __GET_LOCATED(data__->PS_1,)) && __GET_VAR(data__->_TMP_EQ125_OUT,)),
    (INT)__GET_VAR(data__->STATE_3,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE133_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_1,,__GET_VAR(data__->_TMP_MOVE133_OUT,));
  };
  ...
  __SET_VAR(data__->,_TMP_MOVE144_OUT,,__TAG_DISPLAY_MOVE__INT__INT4(
    (BOOL)((!(__GET_LOCATED(data__->BAGGING,)) && __GET_LOCATED(data__->CONVEYOR_2,)) && __GET_VAR(data__->_TMP_EQ130_OUT,)),
    (INT)__GET_VAR(data__->STATE_4,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE144_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_1,,__GET_VAR(data__->_TMP_MOVE144_OUT,));
  };
  if (((!(__GET_LOCATED(data__->BAGGING,)) && __GET_LOCATED(data__->CONVEYOR_2,)) && __GET_VAR(data__->_TMP_EQ130_OUT,))) {
    __SET_LOCATED(data__->,CONVEYING_2,,__BOOL_LITERAL(TRUE));
  };
  ...
  __SET_VAR(data__->,_TMP_MOVE156_OUT,,__TAG_DISPLAY_MOVE__INT__INT5(
    (BOOL)(!(__GET_LOCATED(data__->PS_2,)) && __GET_VAR(data__->_TMP_EQ141_OUT,)),
    (INT)__GET_VAR(data__->STATE_0,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE156_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_1,,__GET_VAR(data__->_TMP_MOVE156_OUT,));
  };
  __SET_VAR(data__->,_TMP_EQ154_OUT,,EQ__BOOL__INT(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (INT)__GET_LOCATED(data__->MACHINE_2,),
    (INT)__GET_VAR(data__->STATE_0,)));
  if (((__GET_LOCATED(data__->PS_3,) && __GET_LOCATED(data__->CONVEYOR_3,)) && __GET_VAR(data__->_TMP_EQ154_OUT,))) {
    __SET_LOCATED(data__->,CONVEYING_3,,__BOOL_LITERAL(TRUE));
  };
  __SET_VAR(data__->,_TMP_MOVE163_OUT,,__TAG_DISPLAY_MOVE__INT__INT6(
    (BOOL)((__GET_LOCATED(data__->PS_3,) && __GET_LOCATED(data__->CONVEYOR_3,)) && __GET_VAR(data__->_TMP_EQ154_OUT,)),
    (INT)__GET_VAR(data__->STATE_1,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE163_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_2,,__GET_VAR(data__->_TMP_MOVE163_OUT,));
  };
  __SET_VAR(data__->,_TMP_EQ171_OUT,,EQ__BOOL__INT(
    ...
    (INT)__GET_LOCATED(data__->MACHINE_2,),
    (INT)__GET_VAR(data__->STATE_1,)));
  if (((__GET_LOCATED(data__->TAPER,) && __GET_LOCATED(data__->PS_4,)) && __GET_VAR(data__->_TMP_EQ171_OUT,))) {
    __SET_LOCATED(data__->,TAPING,,__BOOL_LITERAL(TRUE));
  };
  __SET_VAR(data__->,_TMP_MOVE188_OUT,,__TAG_DISPLAY_MOVE__INT__INT7(
    (BOOL)((__GET_LOCATED(data__->TAPER,) && __GET_LOCATED(data__->PS_4,)) && __GET_VAR(data__->_TMP_EQ171_OUT,)),
    (INT)__GET_VAR(data__->STATE_2,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE188_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_2,,__GET_VAR(data__->_TMP_MOVE188_OUT,));
  };
  __SET_VAR(data__->,_TMP_EQ197_OUT,,EQ__BOOL__INT(
    ...
    (INT)__GET_LOCATED(data__->MACHINE_2,),
    (INT)__GET_VAR(data__->STATE_2,)));
  if ((((__GET_LOCATED(data__->CONVEYOR_4,) && !(__GET_LOCATED(data__->TAPING,))) && !(__GET_LOCATED(data__->PS_5,))) && __GET_VAR(data__->_TMP_EQ197_OUT,))) {
    __SET_LOCATED(data__->,CONVEYING_4,,__BOOL_LITERAL(TRUE));
  };
  __SET_VAR(data__->,_TMP_MOVE205_OUT,,__TAG_DISPLAY_MOVE__INT__INT8(
    (BOOL)(((__GET_LOCATED(data__->CONVEYOR_4,) && !(__GET_LOCATED(data__->TAPING,))) && !(__GET_LOCATED(data__->PS_5,))) && __GET_VAR(data__->_TMP_EQ197_OUT,)),
    (INT)__GET_VAR(data__->STATE_0,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE205_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_2,,__GET_VAR(data__->_TMP_MOVE205_OUT,));
  };
  __SET_VAR(data__->,_TMP_EQ219_OUT,,EQ__BOOL__INT(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (INT)__GET_LOCATED(data__->MACHINE_3,),
    (INT)__GET_VAR(data__->STATE_2,)));
  __SET_VAR(data__->,_TMP_MOVE231_OUT,,__TAG_DISPLAY_MOVE__INT__INT9(
    (BOOL)(__GET_LOCATED(data__->PALLETIZER,) && __GET_VAR(data__->_TMP_EQ219_OUT,)),
    (INT)__GET_VAR(data__->STATE_3,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE231_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_3,,__GET_VAR(data__->_TMP_MOVE231_OUT,));
  };
  if ((__GET_LOCATED(data__->PALLETIZER,) && __GET_VAR(data__->_TMP_EQ219_OUT,))) {
    __SET_LOCATED(data__->,PALLETIZER_MOVING,,__BOOL_LITERAL(TRUE));
  };
  __SET_VAR(data__->,_TMP_EQ243_OUT,,EQ__BOOL__INT(
    ...
    (INT)__GET_LOCATED(data__->MACHINE_3,),
    (INT)__GET_VAR(data__->STATE_4,)));
  if ((((!(__GET_LOCATED(data__->WRAPPER_WRAPPING,)) && !(__GET_LOCATED(data__->WRAPPER_CONVEYING,))) && __GET_LOCATED(data__->PALLETIZER,)) && __GET_VAR(data__->_TMP_EQ243_OUT,))) {
    __SET_LOCATED(data__->,PALLETIZER_MOVING,,__BOOL_LITERAL(TRUE));
  };
  __SET_VAR(data__->,_TMP_MOVE281_OUT,,__TAG_DISPLAY_MOVE__INT__INT10(
    (BOOL)(((!(__GET_LOCATED(data__->WRAPPER_WRAPPING,)) && !(__GET_LOCATED(data__->WRAPPER_CONVEYING,))) && __GET_LOCATED(data__->PALLETIZER,)) && __GET_VAR(data__->_TMP_EQ243_OUT,)),
    (INT)__GET_VAR(data__->STATE_5,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE281_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_3,,__GET_VAR(data__->_TMP_MOVE281_OUT,));
  };
  ...
  if (__GET_VAR(data__->_TMP_MOVE228_ENO,)) {
    __SET_LOCATED(data__->,PALLETIZER_ROTATION,,__GET_VAR(data__->_TMP_MOVE228_OUT,));
  };
  ...
  if (__GET_VAR(data__->_TMP_MOVE241_ENO,)) {
    __SET_LOCATED(data__->,PALLETIZER_ROTATION,,__GET_VAR(data__->_TMP_MOVE241_OUT,));
  };
  __SET_VAR(data__->,_TMP_ADD248_OUT,,__TAG_DISPLAY_ADD__INT__INT13(
    (BOOL)(__GET_LOCATED(data__->PALLETIZER,) && __GET_VAR(data__->_TMP_EQ264_OUT,)),
    (UINT)2,
    (INT)__GET_LOCATED(data__->BOX_COUNT,),
    (INT)1,
    data__));
  if (__GET_VAR(data__->_TMP_ADD248_ENO,)) {
    __SET_LOCATED(data__->,BOX_COUNT,,__GET_VAR(data__->_TMP_ADD248_OUT,));
  };
  ...
  if (__GET_VAR(data__->_TMP_MOVE252_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_3,,__GET_VAR(data__->_TMP_MOVE252_OUT,));
  };
  __SET_VAR(data__->,_TMP_EQ256_OUT,,EQ__BOOL__INT(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (INT)__GET_LOCATED(data__->MACHINE_4,),
    (INT)__GET_VAR(data__->STATE_0,)));
  ...
  if (((!(__GET_LOCATED(data__->PS_6,)) && __GET_LOCATED(data__->WRAPPER,)) && __GET_VAR(data__->_TMP_AND353_OUT,))) {
    __SET_LOCATED(data__->,WRAPPER_WRAPPING,,__BOOL_LITERAL(TRUE));
  };
  ...
  __SET_VAR(data__->,_TMP_MOVE224_OUT,,__TAG_DISPLAY_MOVE__INT__INT15(
    (BOOL)(((__GET_LOCATED(data__->PALLETIZER,) && !(__GET_LOCATED(data__->PALLETIZER_GRABBING,))) && __GET_LOCATED(data__->PS_5,)) && __GET_VAR(data__->_TMP_EQ210_OUT,)),
    (INT)__GET_VAR(data__->STATE_1,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE224_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_3,,__GET_VAR(data__->_TMP_MOVE224_OUT,));
  };
  __SET_VAR(data__->,_TMP_EQ270_OUT,,EQ__BOOL__INT(
    ...
    (INT)__GET_LOCATED(data__->MACHINE_4,),
    (INT)__GET_VAR(data__->STATE_1,)));
  if (((!(__GET_LOCATED(data__->WRAPPER_WRAPPING,)) && __GET_LOCATED(data__->WRAPPER,)) && __GET_VAR(data__->_TMP_EQ270_OUT,))) {
    __SET_LOCATED(data__->,WRAPPER_CONVEYING,,__BOOL_LITERAL(TRUE));
  };
  __SET_VAR(data__->,_TMP_MOVE290_OUT,,__TAG_DISPLAY_MOVE__INT__INT16(
    (BOOL)((!(__GET_LOCATED(data__->PS_6,)) && __GET_LOCATED(data__->WRAPPER,)) && __GET_VAR(data__->_TMP_AND353_OUT,)),
    (INT)__GET_VAR(data__->STATE_1,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE290_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_4,,__GET_VAR(data__->_TMP_MOVE290_OUT,));
  };
  __SET_VAR(data__->,_TMP_MOVE310_OUT,,__TAG_DISPLAY_MOVE__INT__INT17(
    (BOOL)((!(__GET_LOCATED(data__->WRAPPER_WRAPPING,)) && __GET_LOCATED(data__->WRAPPER,)) && __GET_VAR(data__->_TMP_EQ270_OUT,)),
    (INT)__GET_VAR(data__->STATE_2,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE310_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_4,,__GET_VAR(data__->_TMP_MOVE310_OUT,));
  };
  __SET_VAR(data__->,_TMP_EQ314_OUT,,EQ__BOOL__INT(
    ...
    (INT)__GET_LOCATED(data__->MACHINE_4,),
    (INT)__GET_VAR(data__->STATE_2,)));
  if (((!(__GET_LOCATED(data__->WRAPPER_CONVEYING,)) && __GET_LOCATED(data__->CONVEYOR_5,)) && __GET_VAR(data__->_TMP_EQ314_OUT,))) {
    __SET_LOCATED(data__->,CONVEYING_5,,__BOOL_LITERAL(TRUE));
  };
  __SET_VAR(data__->,_TMP_MOVE321_OUT,,__TAG_DISPLAY_MOVE__INT__INT18(
    (BOOL)((!(__GET_LOCATED(data__->WRAPPER_CONVEYING,)) && __GET_LOCATED(data__->CONVEYOR_5,)) && __GET_VAR(data__->_TMP_EQ314_OUT,)),
    (INT)__GET_VAR(data__->STATE_3,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE321_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_4,,__GET_VAR(data__->_TMP_MOVE321_OUT,));
  };
  if ((__GET_LOCATED(data__->PALLETIZER,) && __GET_VAR(data__->_TMP_EQ264_OUT,))) {
    __SET_LOCATED(data__->,PALLETIZER_GRABBING,,__BOOL_LITERAL(FALSE));
  };
  if ((__GET_LOCATED(data__->PALLETIZER,) && __GET_VAR(data__->_TMP_EQ264_OUT,))) {
    __SET_LOCATED(data__->,PALLETIZER_MOVING,,__BOOL_LITERAL(TRUE));
  };
  if ((__GET_LOCATED(data__->PS_1,) && __GET_VAR(data__->_TMP_EQ125_OUT,))) {
  ...
  __SET_VAR(data__->,_TMP_MOVE336_OUT,,__TAG_DISPLAY_MOVE__INT__INT19(
    (BOOL)(__GET_LOCATED(data__->PS_2,) && __GET_VAR(data__->_TMP_EQ145_OUT,)),
    (INT)__GET_VAR(data__->STATE_5,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE336_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_1,,__GET_VAR(data__->_TMP_MOVE336_OUT,));
  };
  if ((__GET_LOCATED(data__->PS_2,) && __GET_VAR(data__->_TMP_EQ145_OUT,))) {
    __SET_LOCATED(data__->,CONVEYING_2,,__BOOL_LITERAL(FALSE));
  };
  if ((__GET_LOCATED(data__->PS_4,) && __GET_VAR(data__->_TMP_EQ171_OUT,))) {
    __SET_LOCATED(data__->,CONVEYING_3,,__BOOL_LITERAL(FALSE));
  };
  if ((__GET_LOCATED(data__->PS_5,) && __GET_VAR(data__->_TMP_EQ210_OUT,))) {
  ...
  __SET_VAR(data__->,_TMP_MOVE345_OUT,,__TAG_DISPLAY_MOVE__INT__INT20(
    (BOOL)(__GET_LOCATED(data__->PS_6,) && __GET_VAR(data__->_TMP_EQ347_OUT,)),
    (INT)__GET_VAR(data__->STATE_0,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE345_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_4,,__GET_VAR(data__->_TMP_MOVE345_OUT,));
  };
  if ((__GET_LOCATED(data__->PS_6,) && __GET_VAR(data__->_TMP_EQ347_OUT,))) {
    __SET_LOCATED(data__->,CONVEYING_5,,__BOOL_LITERAL(FALSE));
  };
  if ((((__GET_LOCATED(data__->PALLETIZER,) && !(__GET_LOCATED(data__->PALLETIZER_GRABBING,))) && __GET_LOCATED(data__->PS_5,)) && __GET_VAR(data__->_TMP_EQ210_OUT,))) {
    __SET_LOCATED(data__->,PALLETIZER_MOVING,,__BOOL_LITERAL(TRUE));
  };
  ...
  if (__GET_VAR(data__->_TMP_MOVE238_ENO,)) {
    __SET_LOCATED(data__->,PALLETIZER_ROTATION,,__GET_VAR(data__->_TMP_MOVE238_OUT,));
  };
  __SET_VAR(data__->,_TMP_EQ204_OUT,,EQ__BOOL__INT(
    ...
    (INT)__GET_LOCATED(data__->MACHINE_3,),
    (INT)__GET_VAR(data__->STATE_1,)));
  if ((__GET_LOCATED(data__->ROE_1,) && __GET_VAR(data__->_TMP_EQ204_OUT,))) {
    __SET_LOCATED(data__->,PALLETIZER_MOVING,,__BOOL_LITERAL(FALSE));
  };
  ...
  __SET_VAR(data__->,_TMP_MOVE229_OUT,,__TAG_DISPLAY_MOVE__INT__INT22(
    (BOOL)((__GET_LOCATED(data__->PALLETIZER_GRABBING,) && __GET_LOCATED(data__->ROE_2,)) && __GET_VAR(data__->_TMP_EQ232_OUT,)),
    (INT)__GET_VAR(data__->STATE_4,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE229_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_3,,__GET_VAR(data__->_TMP_MOVE229_OUT,));
  };
  if ((__GET_LOCATED(data__->ROE_2,) && __GET_VAR(data__->_TMP_EQ232_OUT,))) {
    __SET_LOCATED(data__->,PALLETIZER_MOVING,,__BOOL_LITERAL(FALSE));
  };
  ...
  if (__GET_VAR(data__->_TMP_MOVE262_ENO,)) {
    __SET_LOCATED(data__->,PALLETIZER_ROTATION,,__GET_VAR(data__->_TMP_MOVE262_OUT,));
  };
  ...
  __SET_VAR(data__->,_TMP_MOVE303_OUT,,__TAG_DISPLAY_MOVE__INT__INT24(
    (BOOL)(__GET_LOCATED(data__->ROE_3,) && __GET_VAR(data__->_TMP_EQ341_OUT,)),
    (INT)__GET_VAR(data__->STATE_6,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE303_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_3,,__GET_VAR(data__->_TMP_MOVE303_OUT,));
  };
  if ((__GET_LOCATED(data__->ROE_3,) && __GET_VAR(data__->_TMP_EQ341_OUT,))) {
    __SET_LOCATED(data__->,PALLETIZER_MOVING,,__BOOL_LITERAL(FALSE));
  };
  ...
  if (__GET_VAR(data__->_TMP_MOVE362_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_3,,__GET_VAR(data__->_TMP_MOVE362_OUT,));
  };
  __SET_VAR(data__->,_TMP_MOVE186_OUT,,__TAG_DISPLAY_MOVE__INT__INT26(
    (BOOL)(__GET_LOCATED(data__->ROE_1,) && __GET_VAR(data__->_TMP_EQ204_OUT,)),
    (INT)__GET_VAR(data__->STATE_2,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE186_ENO,)) {
    __SET_LOCATED(data__->,MACHINE_3,,__GET_VAR(data__->_TMP_MOVE186_OUT,));
  };
  if ((((__GET_LOCATED(data__->PALLETIZER,) && !(__GET_LOCATED(data__->PALLETIZER_GRABBING,))) && __GET_LOCATED(data__->PS_5,)) && __GET_VAR(data__->_TMP_EQ210_OUT,))) {
    __SET_LOCATED(data__->,PALLETIZER_GRABBING,,__BOOL_LITERAL(TRUE));
  };
