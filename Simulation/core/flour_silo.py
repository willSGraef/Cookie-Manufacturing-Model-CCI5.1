...
while not shutdown:
    ...
    redis_client.set_value("lcf_1", lcf_1.get_value())
    redis_client.set_value("lcf_2", lcf_2.get_value())
    redis_client.set_value("lcf_3", lcf_3.get_value())
    redis_client.set_value("lcf_4", lcf_4.get_value())
